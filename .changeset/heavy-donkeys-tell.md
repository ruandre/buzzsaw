...
Fix the developer-experience problems a fresh integration turned up: wrong docs, untyped preset names, a false headless claim, and defaults that failed silently.
