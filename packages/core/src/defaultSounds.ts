...
/// keep-sorted
export const DEFAULT_SOUNDS: Record<string, SoundDefinition> = {
  airRaidSiren: {
    waveType: 'sawtooth',
    frequency: {
      start: 180,
  ...
  // US EAS alert warble: alternating 853 Hz and 960 Hz tones
  broadcastAlert: {
    waveType: 'square',
    frequency: {
      start: 853,
  ...
  // NFPA 72 Temporal-Three evacuation pattern
  evacuationT3: {
    waveType: 'square',
    frequency: 1000,
    gain: {
